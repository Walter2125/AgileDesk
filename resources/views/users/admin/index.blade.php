...
<!-- Tabler Core CSS (Admin Template) -->
    ...
    <link rel="styleshee            // Actualiza la acción del formulario
            ...
            rejectSubmitBtn.disabled = !userId || userId === "0";"{{ asset('css/bootstrap.min.css') }}">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                    ...
                    <div class="d-flex flex-wrap gap-2 mt-3 mt-md-0">
                        ...
                        <a href="{{ route('admin.users') }}" class="btn btn-sm btn-outline-secondary d-flex align-items-center">
