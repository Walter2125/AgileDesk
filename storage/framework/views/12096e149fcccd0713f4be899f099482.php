    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center space-x-6">
                <!-- Enlaces -->
                <div class="flex items-center space-x-6">                    <?php if (isset($component)) { $__componentOriginalc295f12dca9d42f28a259237a5724830 = $component; } ?>
...
<?php /**PATH C:\Users\gutya\Desktop\AgileDesk\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>