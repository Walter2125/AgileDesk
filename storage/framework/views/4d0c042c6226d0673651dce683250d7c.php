...
<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
 ...
 <div class="historia-header">
                    <div class="historia-header d-flex justify-content-between align-items-start">
                        ...
                        <a href="<?php echo e(route('tareas.show', $historia->id)); ?>" class="inline-block bg-teal-500 border border-teal-500 rounded font-bold text-white text-base px-3 py-2 transition duration-300 ease-in-out hover:no-underline hover:bg-teal-700 mr-3 normal-case" data-bs-toggle="tooltip" title="Crea una Tarea"><i class="bi bi-plus-lg"></i></a>
                    ...
                    <div class="historia-content">
                        ...
                        <div class="historia-details md-3">
                            <div class="detail-item">
                                ...
                                <span class="detail-value"><?php echo e($historia->columna?->nombre ?? 'Sin estado asignado'); ?></span>
                            </div>
                            <div class="detail-item">
                                ...
                                <span class="detail-value">
                                    <?php echo e($historia->usuario ? $historia->usuario->name : 'No asignado'); ?>
                                               ...
                                               <div class="d-flex justify-content-end align-items-center mt-4 pt-3 border-top gap-2">
                                                <a href="<?php echo e(route('tableros.show', $historia->proyecto_id)); ?>"
                                                ...
                                                <a href="<?php echo e(route('historias.edit', $historia->id)); ?>"
                                                ...
                                                <form action="<?php echo e(route('historias.destroy', $historia->id)); ?>" method="post" class="d-inline">
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            data-bs-target="#deleteHistoriaModal<?php echo e($historia->id); ?>">
                                                            Borrar
                                                    </button>
                                                </form>
                                            </div>

                            <div class="modal fade" id="deleteHistoriaModal<?php echo e($historia->id); ?>" tabindex="-1" aria-labelledby="deleteHistoriaModalLabel<?php echo e($historia->id); ?>" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content rounded-4 shadow">
                                        ...
                                        <div class="modal-body text-center">
                                                <div class="mb-4">
                                                    <h5 class="modal-title text-danger" id="deleteHistoriaModalLabel<?php echo e($historia->id); ?>">Confirmar Eliminación</h5>
                                                    ...
                                                    <div class="alert alert-danger d-flex align-items-center mt-3">
                                                        ...
                                                        <div>
                                                            "<strong><?php echo e($historia->nombre); ?></strong>" será eliminada permanentemente.
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="card mt-5 shadow border-0 rounded-4">
            ...
            <div class="card-body bg-light p-4">
                ...
                <?php $__currentLoopData = $historia->comentarios->where('parent_id', null); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comentario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border rounded-4 p-4 mb-4 bg-white shadow-sm">
                            ...
                            <?php if(Auth::id() === $comentario->user_id): ?>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <form action="<?php echo e(route('comentarios.destroy', $comentario)); ?>" method="POST" onsubmit="return confirm('¿Deseas eliminar este comentario?')">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="button" class="btn btn-outline-danger px-2 py-1" data-bs-toggle="modal" data-bs-target="#confirmDeleteComentario<?php echo e($comentario->id); ?>">
                                            <i class="bi bi-trash fs-5"></i>
                                        </button>
                                    </form>
                                </div>
                            <?php endif; ?>
                            <div class="modal fade" id="confirmDeleteComentario<?php echo e($comentario->id); ?>" tabindex="-1" aria-labelledby="modalLabelComentario<?php echo e($comentario->id); ?>" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content rounded-4 shadow">
                                        <div class="modal-header border-bottom-0">
                                            <h5 class="modal-title text-danger" id="modalLabelComentario<?php echo e($comentario->id); ?>">Confirmar Eliminación</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                        </div>
                                        <div class="modal-body text-center">
                                            <i class="bi bi-exclamation-triangle-fill text-danger" style="font-size: 3rem;"></i>
                                            ...
                                            <div class="d-flex justify-content-end gap-2 mt-4">
                                                ...
                                                <form action="<?php echo e(route('comentarios.destroy', $comentario)); ?>" method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="submit" class="btn btn-danger">Eliminar</button>
                                                </form>
                        ...
                        <?php $__currentLoopData = $comentario->respuestas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $respuesta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <?php if(Auth::id() === $respuesta->user_id): ?>
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                                <button type="button" class="btn btn-outline-danger px-2 py-1" data-bs-toggle="modal" data-bs-target="#confirmDeleteRespuesta<?php echo e($respuesta->id); ?>">
                                                    <i class="bi bi-trash fs-5"></i>
                                                </button>
                                            </form>
                                        </div>
                            ...
                            <div class="modal fade" id="confirmDeleteRespuesta<?php echo e($respuesta->id); ?>" tabindex="-1" aria-labelledby="modalLabelRespuesta<?php echo e($respuesta->id); ?>" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content rounded-4 shadow">
                                        <div class="modal-header border-bottom-0">
                                            <h5 class="modal-title text-danger" id="modalLabelRespuesta<?php echo e($respuesta->id); ?>">Confirmar Eliminación</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                        </div>
                                        <div class="modal-body text-center">
                                            <i class="bi bi-exclamation-triangle-fill text-danger" style="font-size: 3rem;"></i>
                                            ...
                                            <div class="d-flex justify-content-end gap-2 mt-4">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                                <form action="<?php echo e(route('comentarios.destroy', $respuesta)); ?>" method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="submit" class="btn btn-danger">Eliminar</button>
                                                </form>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <div class="modal fade" id="confirmDeleteComentario<?php echo e($comentario->id); ?>" tabindex="-1" aria-labelledby="modalLabel<?php echo e($comentario->id); ?>" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content rounded-4 shadow">
                                        <div class="modal-header border-bottom-0">
                                            <h5 class="modal-title text-danger" id="modalLabel<?php echo e($comentario->id); ?>">Confirmar Eliminación</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                        </div>
                                        <div class="modal-body text-center">
                                            <i class="bi bi-exclamation-triangle-fill text-danger" style="font-size: 3rem;"></i>
