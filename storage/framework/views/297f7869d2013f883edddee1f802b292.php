    ...
    <div class="container-fluid p-0">
        <div class="row m-0">
            <div class="col-12 p-4">
                <h2 class="mb-4">Editar Proyecto: <?php echo e($project->name); ?></h2>
                ...
                <form id="editProjectForm" method="POST" action="<?php echo e(route('projects.update', $project->id)); ?>">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input id="name" type="text" class="form-control" name="name"
                               value="<?php echo e(old('name', $project->name)); ?>" required autocomplete="off">
                    </div>
                    <!-- Descripción -->
                    <div class="form-group mb-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\trimi\AgileDesk\resources\views/projects/edit.blade.php ENDPATH**/ ?>