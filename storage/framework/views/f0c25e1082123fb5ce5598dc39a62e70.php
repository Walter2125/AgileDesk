...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('vendor/bootstrap-icons/bootstrap-icons-fixed.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('vendor/fontawesome/all-fixed.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/breadcrumb-fixes.css')); ?>">
            ...
            <div class="sidebar-content">
                ...
                <div class="list-group list-group-flush mb-auto">
                    ...
                    <?php if(isset($currentProject) && $currentProject instanceof \App\Models\Project): ?>
                        ...
                        <a href="<?php echo e(route('sprints.index', ['project' => $currentProject->id])); ?>" class="list-group-item list-group-item-action text-white">
...
<?php endif; ?>
    ...
    <script src="<?php echo e(asset('js/breadcrumb-fix.js')); ?>"></script>
